...
Item {
  ...
  Component.onCompleted: {
    // A plugin loaded after the event stream starts must also see its initial windows.
    root.handleNiriEvent({ WindowsChanged: { windows: Niri.windows } })
