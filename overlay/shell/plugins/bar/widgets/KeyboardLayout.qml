...
BarWidget {
  ...
  readonly property string layoutFull: Niri.keyboard.names[Niri.keyboard.current_idx] || ""
  readonly property bool multipleLayouts: Niri.keyboard.names.length > 1
  ...
  function cycleLayout() { Niri.cycleLayout() }
